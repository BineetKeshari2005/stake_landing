  ...
  return (
    <section style={{
        ...
        <div ref={cardRef} style={{
          ...
          <div style={{ position: 'relative', aspectRatio: '16/8', width: '100%' }}>
            ...
            <div style={{
              ...
              opacity: 0.35, mixBlendMode: 'overlay', backdropFilter: 'blur(0.3px)'
            }}>
              <svg width="100%" height="100%">
                <defs>
                  <pattern id="jigsaw" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                    <path fill="none" stroke="rgba(255,255,255,0.8)" strokeWidth="1.5"
                          d="M0 0 h25 c 0 -15, 30 -15, 30 0 h25 v25 c 15 0, 15 30, 0 30 v25 h-25 c 0 15, -30 15, -30 0 h-25 v-25 c -15 0, -15 -30, 0 -30 z" />
                  </pattern>
                </defs>
                <rect x="0" y="0" width="100%" height="100%" fill="url(#jigsaw)" />
              </svg>
            </div>
            ...
            {/* FLOATING PIECE 1 */}
            <div style={{
              position: 'absolute', width: 110, height: 110, bottom: '22%', left: '40%', zIndex: 10,
              borderRadius: 12, border: '2.5px solid rgba(255,255,255,.5)', overflow: 'hidden',
              boxShadow: '0 12px 30px rgba(0,0,0,0.5)',
              animation: 'floatPiece1 4s ease-in-out infinite', transform: 'rotate(-10deg)'
            }}>
            ...
            {/* FLOATING PIECE 2 */}
            <div style={{
              position: 'absolute', width: 78, height: 78, bottom: '10%', left: '54%', zIndex: 10,
              borderRadius: 10, border: '2px solid rgba(255,255,255,.45)', overflow: 'hidden',
              boxShadow: '0 12px 30px rgba(0,0,0,0.5)',
              animation: 'floatPiece2 4.6s ease-in-out infinite', transform: 'rotate(10deg)'
            }}>
            ...
            <div style={{
              ...
              display: 'flex', flexDirection: 'row', alignItems: 'center', zIndex: 10,
              animation: 'chevronPulseRight 1.8s ease-in-out infinite'
            }}>
              {[0, 1, 2].map((i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    width: '28px', height: '44px', backgroundColor: '#f97316',
                    clipPath: 'polygon(0 0, 50% 50%, 0 100%, 25% 100%, 75% 50%, 25% 0)',
      ...
      <style>{`
        ...
        @keyframes floatPiece1  { 0%,100%{transform:rotate(-10deg) translateY(0)} 50%{transform:rotate(-10deg) translateY(-14px)} }
        @keyframes floatPiece2  { 0%,100%{transform:rotate(10deg) translateY(0)}  50%{transform:rotate(10deg) translateY(-10px)} }
        @keyframes chevronPulseRight { 0%,100%{transform:translateY(-50%) translateX(0)} 50%{transform:translateY(-50%) translateX(10px)} }
